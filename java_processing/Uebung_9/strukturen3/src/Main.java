...
import strukturen3.Adresse;
import strukturen3.Adresstyp;

public class Main {
    public static void main(String[] args) {
        Adresse[] db_adressen1 = {
                new Adresse("Geschäftlich", "Gurn", "Michael", "Lazarettstr.", "1", "88250", "Weingarten"),
                new Adresse("Privat", "Gurn", "Michael", "Heidekrautweg", "11", "88410", "Bad Wurzach"),
                new Adresse("Geschäftlich", "Friedrich", "Michael", "Lazarettstr.", "1", "88250", "Weingarten"),
                new Adresse("Geschäftlich", "Lazarettstr.", "1", "88250", "Weingarten"),
                new Adresse("Geschäftlich", "Lazar", "Christian", "Lazarettstr.", "1", "88250", "Weingarten"),
                new Adresse("Geschäftlich", "Mutschler", "Bela", "Lazarettstr.", "1", "88250", "Weingarten"),
                new Adresse("Geschäftlich", "Reichle", "Heidi", "Lazarettstr.", "1", "88250", "Weingarten")
        };

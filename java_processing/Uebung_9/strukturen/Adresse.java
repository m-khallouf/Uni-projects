...
public class Adresse {
    ...
    public String toString() {
        if (name.length() | firstName.length() == 0){
            return "Keine Namensangabe";
        } else if (street.length() || houseNumber.length() == 0) {
            return "Keine Adressenangabe";
        } else  {
            return "Keine PLZ-Stadtandgabe"
        }
